...
scene_graphs = t.Literal["complete", "swin-3", "swin-5", "swin-7", "logwin-3", "logwin-5", "logwin-7", "oneref"]
...
def make_pairs(
    imgs: t.List["TypedLoadImageOutput"],
    scene_graph: scene_graphs = "complete",
    prefilter=None,
    symmetrize: bool = True,
) -> t.List[t.Tuple["TypedLoadImageOutput", "TypedLoadImageOutput"]]:
    pairs = []
    if scene_graph == "complete":  # complete graph
        ...
        raise ValueError(f"Unknown scene graph {scene_graph}")
